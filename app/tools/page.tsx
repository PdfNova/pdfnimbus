...
function ToolCard({
  ...
  if (!active) {
    return <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 opacity-90">{content}</div>;
  }

  return (
    <Link
      href={href}
      className="rounded-xl border border-slate-200 bg-white p-4 transition hover:border-brand-400 hover:bg-brand-50"
    >
      {content}
    </Link>
  );
  ...
  return (
    <main className="mx-auto w-full max-w-[1300px] px-4 py-6 sm:px-6 sm:py-8">
      <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <h1 className="mt-2 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">All PDFNova Tools</h1>
      ...
      <section className="mt-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
        <h2 className="text-xl font-semibold text-slate-900">All PDF tools</h2>
      ...
      <section className="mt-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
        <h2 className="text-xl font-semibold text-slate-900">Future categories</h2>
