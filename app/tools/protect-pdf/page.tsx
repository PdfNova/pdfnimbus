...
import { ProtectPdfTool } from "@/components/tools/protect-pdf/protect-pdf-tool";

const faqItems = [
  {
    question: "Is this Protect PDF tool free to use?",
  ...
  return (
    <main className="mx-auto w-full max-w-5xl px-4 py-8 sm:px-6 sm:py-12">
      <header className="mb-8">
        <h1 className="text-2xl font-semibold tracking-tight text-slate-900 sm:text-3xl">Protect PDF Online</h1>
